...
int main(void)
{
	...
	WRITE_BITS(SYSCFG_BASE+SYSCFG_EXTICR1_OFFSET,EXTI0_3_BIT,EXTI0_0_BIT,0000);

	//EXTI Configurations
	SET_BIT(EXTI_BASE+EXTI_IMR_OFFSET,MR0);
	/*SET_BIT(EXTI_BASE+EXTI_RTSR_OFFSET,TR0);*/
	SET_BIT(EXTI_BASE+EXTI_RTSR_OFFSET,TR0);
	SET_BIT(EXTI_BASE+EXTI_PR_OFFSET,PR0);
